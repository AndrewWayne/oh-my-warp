...
| Current 0.0.12 release candidate | Release EXE `CBBF648558EE71555712D913F9622D282E3047513C560ABF913DBE65251650CA`, 295,974,912 bytes, staged at `dist/staging-v0.0.12-dogfood.pane-phone.20260826-windows/omw-warp-oss.exe` and embedded byte-identically in ZIP `A47BEDA48E7F9E5E54CA2C7EEA503BDE8D82C8C0F2B989CA880A5C4228C7372A`, 190,243,587 bytes. The locked/offline package build, clean-PATH helper/kernel probes, required payload checks, 16,769 manifest hashes, archive path/duplicate checks, PDB exclusion, package-lock preservation, LF checksum sidecar, and independent source/staged forbidden-hostname audits pass. Automated gutter and persistent per-pane phone-action regressions pass. Desktop visual and physical-iPhone acceptance are `NOT RUN`. |
